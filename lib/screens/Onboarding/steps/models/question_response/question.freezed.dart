...
abstract class $QuestionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? question, String? type, List<Option>? option});
}
...
class _$QuestionImpl implements _Question {
  _$QuestionImpl(
      {this.id, this.question, this.type, final List<Option>? option})
      : _option = option;
  ...
  @override
  String toString() {
    return 'Question(id: $id, question: $question, type: $type, option: $option)';
  }
...
abstract class _Question implements Question {
  factory _Question(
      ...
      final String? question,
      final String? type,
      final List<Option>? option}) = _$QuestionImpl;
