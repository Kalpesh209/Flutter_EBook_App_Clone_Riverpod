...
class EBookViewAll extends ConsumerStatefulWidget {
  final String title;
  final String type;

  const EBookViewAll({super.key, required this.title, required this.type});

  @override
  EBookViewAllState createState() => EBookViewAllState();
}

enum SampleItem { itemOne, itemTwo, itemThree }

class EBookViewAllState extends ConsumerState<EBookViewAll> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.watch(homeProviderNew).allEBookByType(widget.type, "1");
    });
  }
