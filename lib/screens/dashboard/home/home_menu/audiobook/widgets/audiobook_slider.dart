...
import '../providers/audiobooks_slider_provider.dart';

class ABookSlider extends ConsumerStatefulWidget {
  const ABookSlider({Key? key}) : super(key: key);

  @override
  ABookSliderState createState() => ABookSliderState();
}

class ABookSliderState extends ConsumerState<ABookSlider> {
  @override
  void initState() {
    super.initState();
    ref.read(audioBookSliderProvider).getAudiobooksCarousel();
  }

  @override
  Widget build(BuildContext context) {
    var state = ref.watch(audioBookSliderProvider);
    return Column(
