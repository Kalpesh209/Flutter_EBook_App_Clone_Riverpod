...
class AllBooksCategoryWiseResponse {
  Data? data;
  bool? success;
  String? message;

  AllBooksCategoryWiseResponse({this.data, this.success, this.message});

  AllBooksCategoryWiseResponse.fromJson(Map<String, dynamic> json) {
