...
import '../library/tabs/trending_book.dart';
...
class CheckOut extends ConsumerStatefulWidget {
  ...
  @override
  CheckOutStatee createState() => CheckOutStatee();
}

class CheckOutStatee extends ConsumerState<CheckOut> {
  @override
  void initState() {
    super.initState();
              ...
              onPressed: () async {
                ...
                if ((state.books.length + allowed) > 3) {
                  SnackbarHelper.error(
                      "You can select max. 3 books for cart in 10 days");
                } else {
                  try {
