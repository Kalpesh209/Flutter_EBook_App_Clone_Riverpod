...
class _$AddressResponseImpl implements _AddressResponse {
  _$AddressResponseImpl({this.data, this.success, this.message});
  ...
  @override
  String toString() {
    return 'AddressResponse(data: $data, success: $success, message: $message)';
  }
...
abstract class _AddressResponse implements AddressResponse {
  factory _AddressResponse(
      {final Data? data,
      final bool? success,
      final String? message}) = _$AddressResponseImpl;
