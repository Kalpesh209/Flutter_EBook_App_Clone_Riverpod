...
class _$CartResponseImpl implements _CartResponse {
  _$CartResponseImpl({this.data, this.success, this.message});
  ...
  @override
  String toString() {
    return 'CartResponse(data: $data, success: $success, message: $message)';
  }
...
abstract class _CartResponse implements CartResponse {
  factory _CartResponse(
      {final Data? data,
      final bool? success,
      final String? message}) = _$CartResponseImpl;
