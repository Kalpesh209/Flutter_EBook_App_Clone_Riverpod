...
import '../../library/library/widgets/library_book_card.dart';

class LiteraryPicksSliderProvider extends ConsumerWidget {
  final String id;
  final String image;
  final String title;
  ...
  const LiteraryPicksSliderProvider({
    Key? key,
    required this.id,
    required this.image,
    required this.title,
