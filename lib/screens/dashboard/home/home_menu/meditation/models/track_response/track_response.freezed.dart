...
class _$TrackResponseImpl implements _TrackResponse {
  _$TrackResponseImpl({this.data, this.success, this.message});
  ...
  @override
  String toString() {
    return 'TrackResponse(data: $data, success: $success, message: $message)';
  }
...
abstract class _TrackResponse implements TrackResponse {
  factory _TrackResponse(
      {final Data? data,
      final bool? success,
      final String? message}) = _$TrackResponseImpl;
