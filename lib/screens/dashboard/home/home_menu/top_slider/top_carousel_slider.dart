...
import 'package:flutter_ebook_app_clone_riverpod/screens/dashboard/home/home_menu/top_slider/top_carousel_slider_provider.dart';
import 'package:flutter_ebook_app_clone_riverpod/screens/dashboard/home/models/book_details_modal.dart';
import 'package:get/get.dart';

class TopCarouselSlider extends ConsumerWidget {
  final String categoryId;
  final String bookType;
  final Function(BookDetailsModal bookDetailsModal) onTap;

  const TopCarouselSlider(this.categoryId, this.bookType, this.onTap,
      {Key? key})
      : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    var state = ref.watch(topCarouselSliderProvider([categoryId, bookType]));
    return Column(
      children: [
        FlutterCarousel(
          items: List.generate(
