...
class _$BookOrderImpl implements _BookOrder {
  _$BookOrderImpl(
      {@JsonKey(name: 'is_expanded') this.isExpanded,
  ...
  @override
  String toString() {
    return 'BookOrder(isExpanded: $isExpanded, orderId: $orderId, bookTitle: $bookTitle, releaseYear: $releaseYear, language: $language, about: $about, coverImage: $coverImage, bookTag: $bookTag, tag: $tag, isPublish: $isPublish, orderNumber: $orderNumber, user: $user, bookMaster: $bookMaster, orderAddress: $orderAddress, orderDate: $orderDate, assignDate: $assignDate, returnDate: $returnDate, orderStatus: $orderStatus, bookCondition: $bookCondition, image: $image, remark: $remark)';
  }
...
abstract class _BookOrder implements BookOrder {
  factory _BookOrder(
      {@JsonKey(name: 'is_expanded') final bool? isExpanded,
      ...
      final dynamic image,
      final dynamic remark}) = _$BookOrderImpl;
