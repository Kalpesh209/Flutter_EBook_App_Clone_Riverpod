...
class WalletOldScreen extends ConsumerStatefulWidget {
  const WalletOldScreen({super.key});

  @override
  WalletScreenState createState() => WalletScreenState();
}

class WalletScreenState extends ConsumerState<WalletOldScreen>
