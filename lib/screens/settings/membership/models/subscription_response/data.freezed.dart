...
class _$DataImpl implements _Data {
  ...
  final List<Subscription>? _subscription;
  @override
  ...
  @override
  String toString() {
    return 'Data(subscription: $subscription, count: $count, allCount: $allCount)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_subscription), count, allCount);
