...
class _$SubscriptionResponseImpl implements _SubscriptionResponse {
  _$SubscriptionResponseImpl({this.data, this.success, this.message});
  ...
  @override
  String toString() {
    return 'SubscriptionResponse(data: $data, success: $success, message: $message)';
  }
...
abstract class _SubscriptionResponse implements SubscriptionResponse {
  factory _SubscriptionResponse(
      {final Data? data,
      final bool? success,
      final String? message}) = _$SubscriptionResponseImpl;
